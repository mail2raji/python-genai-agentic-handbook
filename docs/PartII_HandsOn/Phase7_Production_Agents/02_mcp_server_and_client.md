...
!!! info "Runnable source file"
    **Path:** `Phase7_Production_Agents/02_mcp_server_and_client.py`  
...
#         "command": "python",
#         "args": ["c:/Scripts/Send-escalationEmail/PythonGenAI_Learning/Phase7_Production_Agents/02_mcp_server_and_client.py", "server"]
#       }
#     }
#   }
# ============================================================
