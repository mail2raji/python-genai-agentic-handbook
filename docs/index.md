...
| 1 | A | **[Python Fundamentals](curriculum/Chapter01_Python_Fundamentals/00_START_HERE.md)** | Variables, lists, dicts, conditionals, loops, functions, files — + **Log Analyzer** mini-project. |
| 2 | A | **[Intermediate Python](curriculum/Chapter02_Intermediate_Python/00_START_HERE.md)** | Modules, `venv`+pip, errors, classes, type hints, `requests`, async, secrets — + **Weather Chatbot**. |
| 3 | A | **[Python for AI & Data](curriculum/Chapter03_Python_for_AI_Data/00_START_HERE.md)** | NumPy, Pandas, cosine similarity, tokenisation — + **CSV Analyst**. |
| 4 | A | **[Python for GenAI · deep dive](curriculum/Chapter04_Python_for_GenAI/01_Intro_to_Python.md)** | Files + databases, APIs, calling LLMs end-to-end — + **Invoice → Insights** advanced lab. |
| | **🤖 Stage B — GenAI core** | | *From "what is a token?" to running real RAG.* |
| 5 | B | **[GenAI Fundamentals · hands-on](curriculum/Chapter05_GenAI_Fundamentals/00_START_HERE.md)** | LLMs, prompts, structured outputs, streaming, embeddings, RAG from scratch — + **Doc Q&A** mini-project. |
| 6 | B | **[GenAI Foundations · deep dive](curriculum/Chapter06_GenAI_Foundations/01_Introduction_to_GenAI.md)** | The vocabulary everyone uses: prompts, fine-tuning, RAG, agents — + **Support Triage Assistant** lab. |
| 7 | B | **[LangChain Core](curriculum/Chapter07_LangChain_Core/01_Introduction_to_LangChain.md)** | LCEL, runnables, I/O management, prompt engineering with LangChain — + **Onboarding Wizard** lab. |
| | **🔍 Stage C — RAG** | | *Make AI answer from **your** data.* |
| 8 | C | **[RAG Systems & Frameworks](curriculum/Chapter08_RAG_Systems_Frameworks/01_RAG_System_Essentials.md)** | RAG essentials, LangChain vs LangGraph vs CrewAI — + **Legal RAG with Reranker** lab. |
| | **🧠 Stage D — Agentic AI** | | *Make AI do things, not just answer.* |
| 9 | D | **[Agentic AI · hands-on](curriculum/Chapter09_Agentic_AI_HandsOn/00_START_HERE.md)** | Function calling, ReAct, memory, guardrails, multi-agent, LangGraph — + **IT Triage Agent**. |
| 10 | D | **[Agentic AI Patterns · deep dive](curriculum/Chapter10_Agentic_AI_Patterns/01_Agentic_Design_Patterns.md)** | Reflection, tool use, planning, multi-agent crews — + **Engineering Crew** capstone lab. |
| 11 | D | **[Capstone Projects (IT-ops)](curriculum/Chapter11_Capstones_ITops/00_START_HERE.md)** | 3 full projects: SPN renewal concierge • PowerShell doc buddy • Incident reporter. |
| | **🚀 Stage E — Production** | | *Take an agent from notebook to Kubernetes.* |
| 12 | E | **[Production Agents](curriculum/Chapter12_Production_Agents/00_START_HERE.md)** | MCP, evaluation, observability, failure modes, architecture, AKS deploy — + **Production SPN Agent**. |
| | **🛠️ Stage F — Git / GitHub / Copilot / Security** | | *The professional toolchain you'll use forever.* |
| 13 | F | **[GitHub Setup](curriculum/Chapter13_GitHub_Setup/index.md)** | Account, SSH keys, `gh` CLI, identity. |
| 14 | F | **[Git Fundamentals · 12 labs + capstone](curriculum/Chapter14_Git_Fundamentals/exercises.md)** | init, add -p, branches, merge, conflicts, stash, amend/revert, reflog, .gitignore, tags, cherry-pick, interactive rebase. |
| 15 | F | **[GitHub Basics · 12 labs + capstone](curriculum/Chapter15_GitHub_Basics/exercises.md)** | PRs, reviews, issue forms, releases, projects v2, branch protection, CODEOWNERS, forks, discussions, labels, linking. |
| 16 | F | **[Intermediate Git](curriculum/Chapter16_Intermediate_Git/index.md)** | Rebase, bisect, worktrees, submodules, partial clones. |
| 17 | F | **[GitHub Actions](curriculum/Chapter17_GitHub_Actions/index.md)** | YAML, triggers, matrix builds, secrets, reusable workflows. |
| 18 | F | **[Copilot + GenAI](curriculum/Chapter18_Copilot_GenAI/index.md)** | Pair-programming, prompting Copilot, custom instructions. |
| 19 | F | **[Copilot CLI](curriculum/Chapter19_Copilot_CLI/index.md)** | Terminal-first AI coding. |
| 20 | F | **[Agentic AI with Copilot](curriculum/Chapter20_Agentic_AI_Copilot/index.md)** | Copilot in agent mode + tools + MCP. |
| 21 | F | **[GHAS Admin & Security](curriculum/Chapter21_GHAS_Admin_Security/index.md)** | Secret scanning, code scanning (CodeQL), Dependabot, security policies. |
| 22 | F | **[Exam Prep](curriculum/Chapter22_Exam_Prep/index.md)** | GitHub Advanced Security certification-ready review. |
| 23 | F | **[Final Capstone](curriculum/Chapter23_Final_Capstone/index.md)** | Bring it all together in a single production-grade project. |

> 💡 **Index of every exercise** → [Lab menu](curriculum/LAB_MENU.md). **Setup first** → [SETUP](SETUP.md).
>
...
Happy learning! 🎉 Open **[SETUP](SETUP.md)** to begin, or jump straight into **[Chapter 1 — Hello World](curriculum/Chapter01_Python_Fundamentals/01_hello_world.md)**.
